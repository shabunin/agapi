...
Docs for the `feat/agapi-drivers` integration branch — driver architecture,
branch model, and the guide for adding a new driver. Kept separate from the
root `README.md`, which stays whatever `main` has.
